...
```sh
   ...
   --permit-arguments            Permit clients to send command line arguments in URL and in HTTP header (e.g. http://example.com:8080/?arg=AAA&arg=BBB) (default: false) [$GOTTY_PERMIT_ARGUMENTS]
